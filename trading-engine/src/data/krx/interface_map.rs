...
pub static KRX_TR_CODE_MAP: Lazy<FxHashMap<&'static [u8], &'static str>> = Lazy::new(|| {
    ...
    // IFMSRPD0036
    // 파생 체결
    ["A301F", "A302F", "A303F", "A304F", "A305F", "A306F", "A307F", "A308F", "A309F", 
     "A310F", "A311F", "A312F", "A313F", "A315F", "A316F", "A314F",
     "G701F", "G702F", "G703F", "G706F", "G707F", "G708F", "G709F", "G710F", "G711F", 
     "G712F", "G713F", "G715F", "G716F", "G714F"].iter().for_each(|&code| {
...
mod tests {
    ...
    fn basic_test() {
        ...
        for (tr_code, interface_id) in KRX_TR_CODE_MAP.iter() {
            println!("{:?} -> {:?}", std::str::from_utf8(tr_code).unwrap(), interface_id);
        }
