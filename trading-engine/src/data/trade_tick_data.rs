...
pub struct TradeTickData {
    ...
    //
    ask_prices: SmallVec::<[BookPrice; 5]>,
    ask_quantities: SmallVec::<[BookQuantity; 5]>,
    ask_order_count: SmallVec<[OrderCount; 5]>,
    //
    bid_prices: SmallVec::<[BookPrice; 5]>,
    bid_quantities: SmallVec::<[BookQuantity; 5]>,
    bid_order_count: SmallVec<[OrderCount; 5]>,
}
