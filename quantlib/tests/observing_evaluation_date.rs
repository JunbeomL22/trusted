...
mod tests {
    ...
    use quantlib::definitions::{Time, Real, CLOSING_TIME, SOUTH_KOREA_OFFSET};
    ...
    fn test_shared_evaluation_date() {
        ...
        let evaluation_date = Rc::new(RefCell::new(EvaluationDate::new(evaluation_offsetdatetime.clone())));
        let spot = 1.0;
        ...
        // purturb the evaluation_date by one day 
